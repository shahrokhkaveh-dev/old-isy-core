...
return [
    ...
    'attributes' => [
        ...
        'management_number' => 'Manager Number',
        'management_name' => 'Manager Name',
        'management_profile_image' => 'Manager Profile Image',
        'company_name' => 'Company Name',
        'address' => 'Address',
        'company_code' => 'National ID',
        'company_register' => 'Registration Number',
        'company_postCode' => 'Postal Code',
        'company_phone' => 'Company Phone Number',
        'user_code' => 'National Code',
        'user_Bday' => 'Birth Day',
        'user_Bmonth' => 'Birth Month',
        'user_Byear' => 'Birth Year',
        'province_id' => 'Province',
        'city_id' => 'City',
        'Ncard' => 'National Card Image',
        'Newspaper' => 'Official Gazette Image',
        'lastChange' => 'Last Changes Image',
        'type' => 'Company Type',
        'category_id' => 'Field of Activity'
    ],
];
