...
@section('head')
    ...
    @if (isset($_GET['type_id']))
        @switch($_GET['type_id'])
            ...
            <style>
                .mainHeader::before {
                background: url('{{ asset('image/section seach.jpg') }}');
                }
            </style>
            @break
            ...
            <style>
                .mainHeader::before {
                background: url('{{ asset('image/پیمانکاران.jpg') }}');}
            ...
            <style>
                .mainHeader::before {
                background: url('{{ asset('image/بازرگانان.jpg') }}');}
                </style>
            @break
            ...
            <style>
                .mainHeader::before {
                background: url('{{ asset('image/معدنکاران.jpg') }}');}
                </style>
            @break
        @endswitch
    @else
    ...
    <main class="productsMain">
        <div class="mainHeader">
            ...
            <form action="#" method="get" class="searchForm" id="searchForm">
                ...
                <div class="filters">
                    ...
                    <select class="form-select filterSelect" name="type_id" id="type_id">
                        <option value="">نوع شرکت</option>
                        @foreach ($types as $type)
                            <option value="{{ $type->id }}" @if (isset($_GET['type_id']) && $_GET['type_id'] == $type->id) selected @endif>
                                {{ $type->name }}</option>
                        @endforeach
                    </select>
        ...
        <div class="container">
            @if (!isset($_GET['search']))
                ...
                <div class="row categoryWrapper mt-4">
                    <div class="col-3 col-xxl-2 mt-3">
                        <img data-src="{{ asset('image/powerCategory.png') }}" alt="" class="categoryImage">
                    ...
                    <div class="col-3 col-xxl-2 mt-3">
                        <img data-src="{{ asset('image/خدمات صنعتی.png') }}" alt="" class="categoryImage">
                        <span class="categoryTitle" data-category-id="195">خدمات صنعتی</span>
                    </div>
                    <div class="col-3 col-xxl-2 mt-3">
                        <img data-src="{{ asset('image/فرآورده های غذایی.png') }}" alt="" class="categoryImage">
                        <span class="categoryTitle" data-category-id="197">فرآورده های غذایی</span>
                    </div>
                    <div class="col-3 col-xxl-2 mt-3">
                        <img data-src="{{ asset('image/منسوجات.png') }}" alt="" class="categoryImage">
                        <span class="categoryTitle" data-category-id="199">منسوجات و پوشاک</span>
                    </div>
                    <div class="col-3 col-xxl-2 mt-3">
                        <img data-src="{{ asset('image/کشاورزی.png') }}" alt="" class="categoryImage">
                        <span class="categoryTitle" data-category-id="207">کشاورزی</span>
                    </div>
                    <div class="col-3 col-xxl-2 mt-3">
                        <img data-src="{{ asset('image/شیمیایی.png') }}" alt="" class="categoryImage">
                        <span class="categoryTitle" data-category-id="222">شیمیایی و دارویی</span>
                    </div>

                    <div class="col-3 col-xxl-2 mt-3">
                        <img data-src="{{ asset('image/مبلمان.png') }}" alt="" class="categoryImage">
                        <span class="categoryTitle" data-category-id="269">مبلمان و لوازم خانگی</span>
                    </div>
                    <div class="col-3 col-xxl-2 mt-3">
                        <img data-src="{{ asset('image/بهداشتی و آرایشی.png') }}" alt="" class="categoryImage">
                        <span class="categoryTitle" data-category-id="247">بهداشتی و آرایشی</span>
                    </div>
                    <div class="col-3 col-xxl-2 mt-3">
                        <img data-src="{{ asset('image/معادن.png') }}" alt="" class="categoryImage">
                        <span class="categoryTitle" data-category-id="292">معادن</span>
                    </div>
                    <div class="col-3 col-xxl-2 mt-3">
                        <img data-src="{{ asset('image/صنعت خودرو.png') }}" alt="" class="categoryImage">
                        <span class="categoryTitle" data-category-id="319">صنعت خودرو</span>
                    </div>
                    <div class="col-3 col-xxl-2 mt-3">
                        <img data-src="{{ asset('image/چوب.png') }}" alt="" class="categoryImage">
                        <span class="categoryTitle" data-category-id="320">صنایع چوب و کاغذ</span>
                    </div>
                    <div class="col-3 col-xxl-2 mt-3">
                        <img data-src="{{ asset('image/سایر.png') }}" alt="" class="categoryImage">
                ...
                <div class="text-center mt-5">
                    <div class="ad1350x200box d-inline-block">
                        <a href="" class="adLink">
                            <img data-src="{{ asset('image/tabligh2.png') }}" class="img-fluid" alt="">
                        </a>
                        {{-- <span class="adText">
                        <span>جایگاه تبلیغات شما</span><span>200*1350</span>
                    </span class="adText"> --}}
                    </div>
                </div>
            @endif
            ...
            <div class="row">
                @foreach ($brands as $p)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xxl-2 p-0">
                        <a href="{{ $p->slug ? route('user.brands.show', $p->slug) : '' }}">
                            <div class="productBox">
                                ...
                                <div class="productBoxBody">
                                    @if ($p->logo_path)
                                        <img data-src="{{ asset($p->logo_path) }}" alt="">
                                    @else
