...
@section('content')
    <div class="row m-0 pt-2">
        <div class="col-12 col-md-7">
            <div class="form-check-product">
                <form>
                    <div class="row">
                        <div class="col-md-8">
                            <label class="small">نام و توضیحات محصول</label>
                            <input type="text" class="form-control mt-2" value="{{ $product->name }}">
                        </div>
                        <div class="col-md-4">
                            <label class="small">وضعیت</label>
                            <input type="text" class="form-control mt-2" value="{{ $product->status }}">
                        </div>
                    </div>
                    <textarea class="form-control mt-3">{{ $product->description }}</textarea>
                </form>
        ...
        <div class="col-12 col-md-5 mt-5 mx-0">

            <div class="cart-check-product mt-2">
                ...
                <div class="d-flex justify-content-between pt-3">
                    <p>کاربر ثبت کننده:</p>
                    <p>{{ $product->author? $product->author->first_name . ' ' . $product->author->last_name : '' }}</p>
                </div>
                <div class="d-flex justify-content-between pt-3">
                    <p>تاریخ ثبت:</p>
                ...
                <div class="d-flex justify-content-between mx-3 gp-btn">
                    ...
                    <button type="button" class="btn btn-primary  m-0 mb-2 mb-md-0"
                            onclick="window.location='{{route('admin.approve.product', ['id' => encrypt($product->id)])}}'"
                    >
                    ...
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal77"
                    >
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body mt-5">
                                    <div class="text-center">
                                        ...
                                        <h4 class="mt-4">نیاز به بازبینی محصول</h4>

                                    </div>
                                    <div>
                                        <form method="POST"
                                              action="{{ route('admin.reject.product', ['id' => encrypt($product->id)]) }}">
                                            @csrf
                                            <label class="mt-3">
                                                توضیحات
                                            ...
                                            <textarea
                                                ...
                                                name="description"
                                                rows="10" class="form-control"> {{ $product->rejectionReasons->first()?$product->rejectionReasons->first()->description:'' }} </textarea>
                                            <div class="text-center">
                ...
                <!--                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">-->
                <!--                                <path fill-rule="evenodd" clip-rule="evenodd" d="M1.62534 2.63932C0.75 3.84412 0.75 5.56275 0.75 9C0.75 12.4373 0.75 14.1559 1.62534 15.3607C1.90804 15.7498 2.25022 16.092 2.63932 16.3747C3.84412 17.25 5.56275 17.25 9 17.25C12.4373 17.25 14.1559 17.25 15.3607 16.3747C15.7498 16.092 16.092 15.7498 16.3747 15.3607C17.25 14.1559 17.25 12.4373 17.25 9C17.25 5.56275 17.25 3.84412 16.3747 2.63932C16.092 2.25022 15.7498 1.90804 15.3607 1.62534C14.1559 0.75 12.4373 0.75 9 0.75C5.56275 0.75 3.84412 0.75 2.63932 1.62534C2.25022 1.90804 1.90804 2.25022 1.62534 2.63932ZM7.54158 6.79174C7.27309 6.52326 6.83779 6.52326 6.5693 6.79174C6.30082 7.06023 6.30082 7.49553 6.5693 7.76402L8.02771 9.22242L6.5693 10.6808C6.30082 10.9493 6.30082 11.3846 6.5693 11.6531C6.83779 11.9216 7.27309 11.9216 7.54158 11.6531L8.99998 10.1947L10.4584 11.6531C10.7269 11.9216 11.1622 11.9216 11.4307 11.6531C11.6991 11.3846 11.6991 10.9493 11.4307 10.6808L9.97226 9.22242L11.4307 7.76402C11.6991 7.49553 11.6991 7.06023 11.4307 6.79174C11.1622 6.52326 10.7269 6.52326 10.4584 6.79174L8.99998 8.25015L7.54158 6.79174Z" fill="white"/>-->
                <!--                            </svg>-->

                <!--                            خارج کردن از حالت انتشار-->
                <!--                        </button>-->
            </div>
        </div>
    </div>
    <div class="row m-0">
        <div class="col-12 col-md-7">
            <div class="bg-table-product text-center" style="height: auto;">
                @if($product->attributes)
                    <table>
                        <tbody>
                        <tr>
                            <th style="width: 20%;" class="rounded-right">نام ویژگی</th>
                            <th>مقدار</th>
                            <th class="rounded-left pe-4">توضیحات</th>
                        </tr>
                        @foreach($product->attributes as $attribute)
                            <tr>
                                <td class="rounded-right">{{ $attribute->name }}</td>
                                <td>{{ $attribute->value }}</td>
                                <td class="rounded-left pe-4">-</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
            ...
            <div class="mt-5 videoPlayer">
                <iframe src="https://www.aparat.com/v/JBdmo" height="300" width="100%"></iframe>
            </div>
        </div>
        <div class="col-12 col-md-5 mt-5 pt-5 mx-0">
            <div class="img-list">
                <img class="big-img" src="{{ asset($product->image) }}" alt="">
                <div class="small-img d-flex justify-content-between mt-3">
