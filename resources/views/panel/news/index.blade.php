                ...
                <tbody>
                    @foreach ($news as $key => $product)
                        <tr>
                            ...
                            <th>
                                {{-- <a href="{{ route('panel.news.edit', $product->id) }}"><svg
                                ...
                                <form action="{{ route('panel.news.destroy', $product->id) }}" style="display: inline"
                                    method="post">
                                    @csrf
                                    @method('delete')
                                ...
                                <a href="{{ route('user.news.show' , $product->id) }}" target="_blank">
