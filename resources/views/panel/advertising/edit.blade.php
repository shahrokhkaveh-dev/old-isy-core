                    ...
                    <div class="col-6">
                        <label class="form-check-label" for="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 80 80"
                                ...
                                <defs>
                                    <filter id="filter0_d_172_14" x="0.978882" y="0" width="78.0422"
                        ...
                        <div class="attributeContainer">
                            ...
                            @php
                                ...
                                foreach ($product->attributes as $key => $attributes) {
                                    echo '<input class="d-none ' . $attributes->id . '" name="key[' . $attributes->id . ']" value=' . $attributes->name . '>';
                                    echo '<input class="d-none ' . $attributes->id . '" name="value[' . $attributes->id . ']" value=' . $attributes->value . '>';
                                    echo '<span class="attrTag ' . $attributes->id .'" onClick="deleteAttr('.$attributes->id.')">'.$attributes->name.' : '.$attributes->value .'</span>';
                                    $attrCount++;
                                }
                            @endphp
                        </div>
