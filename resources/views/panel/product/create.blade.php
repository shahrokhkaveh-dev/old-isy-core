...
@section('content')
    <header class="d-flex justify-content-between">
        <h3 class="text-start mt-5">افزودن محصول یا خدمت</h3>
    ...
    <section class="content">
        <div class="container">
            <form action="{{ route('panel.products.store') }}" id="addProduct" method="post" enctype="multipart/form-data"
                    ...
                    <div class="col-12 col-md-5 mt-3">
                        <div>
                            ...
                            <select class="form-select" id="isExportable" name="isExportable">
                                <option @if (old('isExportable') == false) selected @endif value="false">قابلیت صادرات ندارد
                                </option>
                                <option @if (old('isExportable') == true) selected @endif value="true">قابلیت صادرات دارد
                                </option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="mt-3">
                            ...
                            <select class="form-select" id="category_id" name="category_id">
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" @if (old('category') && old('category') == $category->id) selected @endif>
                ...
                <div class="row input-row" style="margin-top:40px; font-size:14px;">
                    <div class="col-12">
                        ...
                        <div id="editorWrapper">
                            <textarea class="form-control" name="description" id="description" maxlength="15"></textarea>
                        </div>
                    </div>
                </div>
