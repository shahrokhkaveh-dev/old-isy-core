    ...
    public function request2(Request $request)
    {
        ...
        $inquiries =   array_map(
            fn($inquiry) => [
                ...
                'product_name' => isset($inquiry['product']) ? $inquiry['product']['name'] : null,
                'product_slug' => isset($inquiry['product']) ? $inquiry['product']['slug'] : null,
                'product_image' => isset($inquiry['product']) ? $inquiry['product']['image'] : null,
